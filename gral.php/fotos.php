...
<html lang="en">
<head>
    <meta charset="UTF-8" charset="UTF-8" <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (refPrevio != '' && refPrevio != null)
            $("#carpetas").load("e-previos/"+refPrevio+" tbody", function(response, status, xhr){
                ...
                $("#carpetas tr").each(function(i){
                    if(i<3 || i==datos) 
                        ...
                        $(this).find("td").each(function(i){
                            ...
                            if(i==1){
                                old=$(this).find("a").attr("href");
                                $(this).find("a").attr("href",'javascript:listaFotos("'+"e-previos/"+refPrevio+"/"+old+'")');
                            }
                        })  
                    }
                });
