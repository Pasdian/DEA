...
/*Directorio Activo*/
define('DOMINIO', 'grupopascal.com.mx');
define('DN', 'dc=grupopascal,dc=com,dc=mx');

/*Base de Datos*/
define('usuario', 'sysdba');
define('passwd', 'masterkey');
define('server', '192.168.0.191:C:/VM2023/vmware/casa/CASA/CASA.GDB');
define('log_dea', '/tmp/log_dea.txt');
